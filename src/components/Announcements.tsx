                ...
                <div className={`bg-gradient-to-r ${announcement.gradient} backdrop-blur-sm border border-gold-light/20 rounded-xl p-6 h-full`}>
                  <div className="flex items-start gap-4 h-full">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <motion.button
                        whileHover={{ x: 5 }}
                        className="text-gold-light flex items-center gap-2 text-sm font-semibold group"
                      >
                        En savoir plus
          ...
          {announcements.map((_, index) => (
            <motion.button
              ...
              animate={{
                ...
                backgroundColor: currentIndex === index ? "hsl(var(--gold-light))" : "hsl(var(--gold-light) / 0.3)",
              }}
