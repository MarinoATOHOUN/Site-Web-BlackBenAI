...
const ProjectDemo = () => {
  ...
  const projectsData: Record<string, any> = {
    ...
    greenmetric: {
      title: "GreenMetric",
      tagline: "Évaluer la durabilité environnementale avec l'IA",
      ...
      features: [
        ...
        { title: "Rapports Automatisés", desc: "Génère des rapports de conformité et de performance environnementale." },
        { title: "Recommandations IA", desc: "Suggère des optimisations pour améliorer la durabilité de vos projets." },
      ],
      demoContent: {
        type: "security",
        stats: [
          { label: "Projets évalués", value: "1,500+" },
          { label: "Précision des modèles", value: "98.2%" },
          { label: "Réduction d'empreinte carbone", value: "-25%" },
    ...
    finetuner: {
      title: "FineTuner",
      tagline: "Fine-tunez vos modèles de langage facilement",
      ...
      features: [
        ...
        { title: "Déploiement en un Clic", desc: "Intégrez vos modèles fine-tunés dans vos applications via une API." },
        { title: "Suivi des Performances", desc: "Visualisez les métriques de performance de vos modèles." },
      ],
      demoContent: {
        type: "signature",
        stats: [
          { label: "Modèles fine-tunés", value: "10,000+" },
          { label: "Temps de développement réduit", value: "-70%" },
          { label: "Taux d'adoption", value: "95%" },
          { label: "Communauté de développeurs", value: "5,000+" },
        ],
      },
    },
    afrollm: {
